...
//
// WHY THIS EXISTS — port of connector#463 (toon-meta#248, relay#118)
// -------------------------------------------------------------------
...
//
// This bit connector three times (connector#462: #430 at 77 min, #422 twice at
// 61 and 73 min) — every one of those runs lost a COMPLETED implementation, the
// failure landing after all the expensive work is done. relay has not been bitten
// yet (longest run to date: 19 minutes), so this is preventive: it is what makes
// raising relay's wall clock (toon-meta#248) safe instead of merely more expensive
// when it fails.
//
// THE FIX
// -------
