...
| route prefix `g.proxy.relay`                       | `g.toon.relay` (`g.proxy` was renamed to `g.toon`; that box has since been retired — see `docs/two-node-architecture.md`, toon-protocol/toon-meta) |
